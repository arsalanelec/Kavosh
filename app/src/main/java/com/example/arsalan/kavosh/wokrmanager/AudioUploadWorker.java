...
public class AudioUploadWorker extends Worker implements Injectable {
    ...
    public AudioUploadWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
                ...
                if (entry.getKey().equals("audio")) {
                    ...
                    final RequestBody requestImageFile =
                            RequestBody.create(
                                    ...
                                    thumbFile);
                    fileBody = MultipartBody.Part.createFormData("audio", thumbFile.getName(), requestImageFile);
                } else {
        ...
        Call<RetroResponse> call = mRetrofit.create(ApiInterface.class).uploadAudio(mToken.getAccessToken(), inputMap, fileBody);
        try {
