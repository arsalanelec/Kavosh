...
public class ExcavationUploadWorker extends Worker implements Injectable {
    ...
    public ExcavationUploadWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        try {
            Call<RetroResponse> call = mRetrofit.create(ApiInterface.class).addExcavation(mToken.getAccessToken(), inputMap);
