...
public class SurFoundUploadWorker extends Worker implements Injectable {
    ...
    public SurFoundUploadWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        Call<RetroResponse> call = mRetrofit.create(ApiInterface.class).createOrUpdateSurFound(mToken.getAccessToken(), inputMap);
        try {
