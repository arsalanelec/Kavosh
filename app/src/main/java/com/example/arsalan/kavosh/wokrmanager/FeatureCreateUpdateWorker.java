...
public class FeatureCreateUpdateWorker extends Worker implements Injectable {

    private final String TAG = "FeatureUploadWorker";
    @Inject
    Retrofit mRetrofit;
    ...
    public FeatureCreateUpdateWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        Call<RetroResponse> call = mRetrofit.create(ApiInterface.class).createFeature(mToken.getAccessToken(), inputMap);
        try {
