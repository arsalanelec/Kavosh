...
public class LayerUploadWorker extends Worker implements Injectable {

    private final String TAG = "LayerUploadWorker";
    @Inject
    Retrofit mRetrofit;
    ...
    public LayerUploadWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        Call<RetroResponse> call = mRetrofit.create(ApiInterface.class).createLayer(mToken.getAccessToken(), inputMap);
        try {
