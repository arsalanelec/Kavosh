...
public class FoundDeleteWorker extends Worker implements Injectable {
    ...
    public FoundDeleteWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        try {
            Call<RetroResponse> call = mRetrofit.create(ApiInterface.class).deleteFound(mToken.getAccessToken(), getInputData().getString(MyConst.EXTRA_ID));
