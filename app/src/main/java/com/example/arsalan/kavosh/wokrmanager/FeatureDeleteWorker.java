...
public class FeatureDeleteWorker extends Worker implements Injectable {

    private final String TAG = "FeatureDeleteWorker";
    @Inject
    Retrofit mRetrofit;
    ...
    public FeatureDeleteWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        try {
            Call<RetroResponse> call = mRetrofit.create(ApiInterface.class).deleteFeature(mToken.getAccessToken(), getInputData().getString(MyConst.EXTRA_LAYER_ID));
