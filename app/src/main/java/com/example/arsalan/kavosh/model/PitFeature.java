...
public class PitFeature extends BaseObservable {

    public static String[] contentHints = {"سفال", "ابزار سنگی", "خاکستر", "پیکرک"};
    ...
    public static void setStructureEntries(String[] structureEntries) {
        PitFeature.structureEntries = structureEntries;
    }
