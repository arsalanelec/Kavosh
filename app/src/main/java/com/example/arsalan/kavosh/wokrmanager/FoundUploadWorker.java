...
public class FoundUploadWorker extends Worker implements Injectable {
    ...
    public FoundUploadWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        Call<RetroResponse> call = mRetrofit.create(ApiInterface.class).createOrUpdateFound(mToken.getAccessToken(), inputMap);
        try {
