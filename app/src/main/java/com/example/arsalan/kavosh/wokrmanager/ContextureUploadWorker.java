...
public class ContextureUploadWorker extends Worker implements Injectable {
    ...
    public ContextureUploadWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        Call<RetroResponse> call = mRetrofit.create(ApiInterface.class).createOrUpdateContexture(mToken.getAccessToken(), inputMap);
        try {
