...
public class SurveyProjectUploadWorker extends Worker implements Injectable {

    private static final String TAG = "SurveyProjectUploadWork";
    @Inject
    Retrofit mRetrofit;
    ...
    public SurveyProjectUploadWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        try {
            Call<RetroResponse> call = mRetrofit.create(ApiInterface.class).addSurveyProject(mToken.getAccessToken(), inputMap);
            ...
            Log.d(TAG, "doWork: error throws:" + throwable.getLocalizedMessage());
            return Result.failure();
        }
