...
public class SurFoundDeleteWorker extends Worker implements Injectable {
    ...
    public SurFoundDeleteWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        try {
            Call<RetroResponse> call = mRetrofit.create(ApiInterface.class).deleteSurFound(mToken.getAccessToken(), getInputData().getString(MyConst.EXTRA_ID));
