...
public class ExcavationItemSaveWorker extends Worker implements Injectable {

    private final String TAG = "ExcavationItemSaveWorker";
    @Inject
    Retrofit mRetrofit;
    ...
    public ExcavationItemSaveWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        Call<RetroResponse> call = mRetrofit.create(ApiInterface.class).saveExcavationItem(mToken.getAccessToken(), inputMap);
        try {
